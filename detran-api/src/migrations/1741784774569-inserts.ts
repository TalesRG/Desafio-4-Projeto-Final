...
export class Inserts1741784774569 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    // Inserção na tabela de locais
    await queryRunner.query(
      `INSERT INTO local (nome, latitude, longitude, velocidade_permitida) VALUES 
    ...
    // Inserção na tabela de agentes de trânsito
    await queryRunner.query(
    ...
    // Inserção na tabela de tipo de infração
    await queryRunner.query(
      `INSERT INTO tipo_infracao (nome, valor, velocidade) VALUES
